    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-200 to-purple-300">
            ...
            <header className="bg-white/80 backdrop-blur-sm shadow-sm">
                <div className="max-w-7x1 mx-auto px-4 py-6 sm:px-6 1g:px-8">
                    <h1 className="text-3x1 font-bold text-gray-900">Terms and Conditions</h1>
                </div>
            </header>
            {/* Main Content */}
            <main className="max-w-7x1 mx-auto px-4 py-8 sm:px-6 1g:px-8">
                <div className="bg-white/98 backdrop-blur-sm shadow-1g rounded-1g overflow-hidden">
                    (/* Introduction */)
                    <div classflame="p-6 border-b border-gray-200">
                        <div classflame="flex items-center gap-2 mb-4">
                            <Scroll className="w-6 h-6 text-purple-700" />
                            <h2 className="text-xl font-semibold text-gray-900">Welcome to Our Platform</h2> </div>
                        <p className="text-gray-600">
                        This website provides a platform for users to explore and order sample-sized beauty and personal care products. Our mission is to allow customers to try products before committing to full-size purchases.
We do not sell full-size products. All items listed are for trial and personal use only.
                    ...
                    <div className="p-6 space-y-8">
                        ...
                        <section>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900">Account Teras</h3>
                        ...
                        <section>
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-1g font-semibold text-gray-900">Product Terms</h3>
                        ...
                        <section>
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-1g font-semibold text-gray-900">Privacy & Security</h3>
                        ...
                        <section>
                            ...
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-1g font-semibold text-gray-900">Legal Rights</h3>
                        ...
                        <section className="bg-purple-100 p-6 rounded-lg">
                            ...
                            <div className="flex items-center gap-2 ab-4">

                                <Heart className="w-6 h-6 text-purple-700" />

                                <h3 className="text-ig font-semibold text-gray-900">Acceptance of Teres</h3>

                            </div>

                            <p className="text-gray-680">

                                By using our platform, you acknowledge that you have read, understood, and agree to be bound by .

                                these terms and conditions.

                                If you do not agree with any part of these teres, you may not use our service
                    ...
                    <div className="bg-purple-100 px-6 py-4 text-sm text-gray-500">

                        <p>Last updated: {new Date().toLocaleDateString()}</p>

                        <p>For any questions regarding these terms, please contact our support team.</p>
                        <p>📄 [Privacy Policy]
                          📧 Contact us at: support@[testandtrust].com
                         © [2025] [Test and Trust]. All rights reserved.</p>
